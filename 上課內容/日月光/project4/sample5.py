...
class Window(tk.Tk):
    def __init__(self):
        ...
        goodbye_button.pack(side=tk.LEFT, padx=(20, 20), pady=(0, 20))

        readcsv_button = tk.Button(self, text="Read CSV File", padx=20, pady=10, font=('Times', 20),
                                   command=self.read_csv)
        readcsv_button.pack(side=tk.LEFT, padx=(0, 20), pady=(0, 20))
